...
if(NOT "include;/home/coworker/libfranka/include " STREQUAL " ")
  set(franka_example_controllers_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/coworker/libfranka/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_example_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/coworker/catkin_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/coworker/catkin_ws/install/lib;/home/coworker/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
